...
interface Commande {  
    ...
    dateCommnade: Date;
    Statut: string;
    MatriculePn?: any;  // ou une interface plus spécifique si disponible
    MatriculeResTun?: any;
    vol?: any;
    menu?: any;
    plats: any[];  
...
@Component({  
    ...
    templateUrl: './commande-mouvements.component.html',  
    styleUrls: ['./commande-mouvements.component.css']  
})  
