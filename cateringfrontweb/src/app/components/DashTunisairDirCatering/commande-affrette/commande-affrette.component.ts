...
export class CommandeAffretteComponent implements OnInit, OnDestroy {
  commandes: any[] = [];
  ...
  modifier(id: string | undefined) {
    if (id) {
      this.router.navigate(['/TunisairCatering/ModifierCommande', id]);
    }
  }
  ...
  ajouter(){
    this.router.navigate(['/TunisairCatering/AjoutCommande'])
  }
}
