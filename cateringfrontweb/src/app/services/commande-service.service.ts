...
export class CommandeServiceService {
  ...
  CommanderMenu(data: any): Observable<any> {
    return this.http.post<any>(`${commandeURL}/menu`, data);
  }

  CommanderPlats(data: any): Observable<any> {
    return this.http.post<any>(`${commandeURL}/plats`, data);
  }
  ...
  // Récupérer les commandes initiales, puis compléter avec les détails des plats
