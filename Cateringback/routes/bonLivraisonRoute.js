...
router.get("/Nonfacture", bonLivraisonController.getBonsNonFacture);/*Ceci pour tunisie catering*/ 
...
router.get("/pdf/:numeroBon", async (req, res) => {/*Ceci pour tunisie catering*/ 
  try {
